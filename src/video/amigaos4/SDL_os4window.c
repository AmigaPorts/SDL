    ...
    if (!OS4_IsFullscreen(window)) {
        data->menuObject = IIntuition->NewObject(NULL, "menuclass",
            ...
            MA_AddChild, IIntuition->NewObject(NULL, "menuclass",
                MA_Type, T_MENU,
                MA_Label, OS4_GetString(MSG_APP_APPLICATION),
                MA_AddChild, IIntuition->NewObject(NULL, "menuclass",
                    MA_Type, T_ITEM,
                    MA_Label, OS4_GetString(MSG_APP_ICONIFY),
                    MA_ID, MID_Iconify,
                    TAG_DONE),
                MA_AddChild, IIntuition->NewObject(NULL, "menuclass",
                    MA_Type, T_ITEM,
                ...
                MA_AddChild, IIntuition->NewObject(NULL, "menuclass",
                    MA_Type, T_ITEM,
                    MA_Label, OS4_GetString(MSG_APP_ABOUT),
                    MA_ID, MID_About,
                    TAG_DONE),
                MA_AddChild, IIntuition->NewObject(NULL, "menuclass",
                    MA_Type, T_ITEM,
                ...
                MA_AddChild, IIntuition->NewObject(NULL, "menuclass",
                    MA_Type, T_ITEM,
                    MA_Label, OS4_GetString(MSG_APP_QUIT),
                    MA_ID, MID_Quit,
                    TAG_DONE),
                TAG_DONE),
            TAG_DONE);
