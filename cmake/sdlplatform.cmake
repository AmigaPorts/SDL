macro(SDL_DetectCMakePlatform)
  ...
  # Get the platform
  if(WARPUP OR CMAKE_SYSTEM_NAME MATCHES "^WarpOS.*")
    set(SDL_CMAKE_PLATFORM AMIGAOS3)
    set(AMIGA TRUE)
    set(AMIGAOS3 TRUE)
    set(WARPUP TRUE)
  elseif(AMIGAOS3 OR CMAKE_SYSTEM_NAME MATCHES "^AmigaOS3.*")
    set(SDL_CMAKE_PLATFORM AMIGAOS3)
    set(AMIGA TRUE)
    set(AMIGAOS3 TRUE)
  elseif(AMIGAOS4 OR CMAKE_SYSTEM_NAME MATCHES "^AmigaOS4.*")
    set(SDL_CMAKE_PLATFORM AMIGAOS4)
    set(AMIGA TRUE)
    set(AMIGAOS4 TRUE)
  elseif(CMAKE_SYSTEM_NAME MATCHES "^Amiga(OS)?$")
    set(AMIGA TRUE)
    if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(m68k|m680[0-9]+)$")
      set(SDL_CMAKE_PLATFORM AMIGAOS3)
      set(AMIGAOS3 TRUE)
    else()
      set(SDL_CMAKE_PLATFORM AMIGAOS4)
